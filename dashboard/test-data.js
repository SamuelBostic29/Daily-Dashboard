    ...
    emails: [
        {
            ...
            meta: 'alice@example.com — 01/01/2026 8:15 AM',
            url: '#',
            preview:
        ...
        },
        {
            ...
            meta: 'bob@example.com — 01/01/2026 7:45 AM',
            url: '#',
            preview:
        ...
        mine: [
            {
                ...
                meta: 'acme/lorem-ipsum · #42 · jdoe · 0d ago',
                url: '#',
            },
            {
                id: 'pr-2',
                title: 'Vestibulum ante ipsum primis in faucibus',
                meta: 'acme/dolor-sit · #17 · jdoe · 3d ago',
                url: '#',
            },
        ],
        review: [
            {
                ...
                meta: 'acme/amet-consectetur · #8 · asmith · 1d ago',
                url: '#',
            },
            {
                id: 'pr-4',
                title: 'Cras mattis consectetur purus sit amet fermentum',
                meta: 'acme/adipiscing-elit · #55 · bjones · 5d ago',
                url: '#',
            },
        ],
    },
    issues: [
        {
            ...
            meta: 'LOREM-101 · Code review · 0d ago',
            url: '#',
        ...
        },
        {
            ...
            meta: 'LOREM-105 · In Progress · 0d ago',
            url: '#',
            labels: ['Sub-task'],
            source: 'Jira',
            parentKey: '1',
        ...
        },
        {
            ...
            meta: 'LOREM-72 · In Progress · 12d ago',
            url: '#',
            labels: ['Bug', 'priority'],
            source: 'Jira',
        },
        {
            ...
            meta: 'acme/adipiscing-elit · #45 · 30d ago',
            url: '#',
            labels: [],
            source: 'GitHub',
        },
        {
            ...
            meta: 'acme/lorem-ipsum · #33 · 45d ago',
            url: '#',
            labels: ['bug'],
            source: 'GitHub',
        },
